...
<main>
    ...
    <section class="month-calendar-container">
        <div class="month-grid-tile">
            <div class="num-of-the-day">1</div>
            <div class="month-event-container"></div>
        </div>
        <div class="month-grid-tile">
            <div class="num-of-the-day">2</div>
            <div class="month-event-container"></div>
        </div>
        <div class="month-grid-tile">
            <div class="num-of-the-day">3</div>
            <div class="month-event-container"></div>
        </div>
        <div class="month-grid-tile">
            <div class="num-of-the-day">4</div>
            <div class="month-event-container"></div>
        </div>
        <div class="month-grid-tile">
            <div class="num-of-the-day">5</div>
            <div class="month-event-container"></div>
        </div>
        <div class="month-grid-tile">
            <div class="num-of-the-day">6</div>
            <div class="month-event-container"></div>
        </div>
        <div class="month-grid-tile">
            <div class="num-of-the-day">7</div>
            <div class="month-event-container"></div>
        </div>
        <div class="month-grid-tile">
            <div class="num-of-the-day">8</div>
            <div class="month-event-container"></div>
        </div>
        <div class="month-grid-tile">
            <div class="num-of-the-day">9</div>
            <div class="month-event-container"></div>
        </div>
        <div class="month-grid-tile">
            <div class="num-of-the-day">10</div>
            <div class="month-event-container"></div>
        </div>
        <div class="month-grid-tile">
            <div class="num-of-the-day">11</div>
            <div class="month-event-container"></div>
        </div>
        <div class="month-grid-tile">
            <div class="num-of-the-day">12</div>
            <div class="month-event-container"></div>
        </div>
        <div class="month-grid-tile">
            <div class="num-of-the-day">13</div>
            <div class="month-event-container"></div>
        </div>
        <div class="month-grid-tile">
            <div class="num-of-the-day">14</div>
            <div class="month-event-container"></div>
        </div>
        <div class="month-grid-tile">
            <div class="num-of-the-day">15</div>
            <div class="month-event-container"></div>
        </div>
        <div class="month-grid-tile">
            <div class="num-of-the-day">16</div>
            <div class="month-event-container"></div>
        </div>
        <div class="month-grid-tile">
            <div class="num-of-the-day">17</div>
            <div class="month-event-container"></div>
        </div>
        <div class="month-grid-tile">
            <div class="num-of-the-day">18</div>
            <div class="month-event-container"></div>
        </div>
        <div class="month-grid-tile">
            <div class="num-of-the-day">19</div>
            <div class="month-event-container"></div>
        </div>
        <div class="month-grid-tile">
            <div class="num-of-the-day">20</div>
            <div class="month-event-container"></div>
        </div>
        <div class="month-grid-tile">
            <div class="num-of-the-day">21</div>
            <div class="month-event-container"></div>
        </div>
        <div class="month-grid-tile">
            <div class="num-of-the-day">22</div>
            <div class="month-event-container"></div>
        </div>
        <div class="month-grid-tile">
            <div class="num-of-the-day">23</div>
            <div class="month-event-container"></div>
        </div>
        <div class="month-grid-tile">
            <div class="num-of-the-day">24</div>
            <div class="month-event-container"></div>
        </div>
        <div class="month-grid-tile">
            <div class="num-of-the-day">25</div>
            <div class="month-event-container"></div>
        </div>
        <div class="month-grid-tile">
            <div class="num-of-the-day">26</div>
            <div class="month-event-container"></div>
        </div>
        <div class="month-grid-tile">
            <div class="num-of-the-day">27</div>
            <div class="month-event-container"></div>
        </div>
        <div class="month-grid-tile">
            <div class="num-of-the-day">28</div>
            <div class="month-event-container"></div>
        </div>
        <div class="month-grid-tile">
            <div class="num-of-the-day">29</div>
            <div class="month-event-container"></div>
        </div>
        <div class="month-grid-tile">
            <div class="num-of-the-day">30</div>
            <div class="month-event-container"></div>
        </div>
        <div class="month-grid-tile">
            <div class="num-of-the-day">31</div>
            <div class="month-event-container"></div>
        </div>
        <div class="month-grid-tile">
            <div class="num-of-the-day"></div>
            <div class="month-event-container"></div>
        </div>
        <div class="month-grid-tile">
            <div class="num-of-the-day"></div>
