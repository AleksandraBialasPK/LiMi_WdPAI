...
<body>
    ...
    <main>
        ...
        <section class="calendar-with-timeline-container">
            ...
            <div class="day-grid-tiles">
                <div class="day-grid-tile" id="first-day-tile"></div>
                <div class="day-grid-tile"></div>
                <div class="day-grid-tile"></div>
                <div class="day-grid-tile"></div>
                <div class="day-grid-tile"></div>
                <div class="day-grid-tile"></div>
                ...
                <div class="day-grid-tile"></div>
                <div class="day-grid-tile"></div>
                <div class="day-grid-tile" id="last-day-tile"></div>
            </div>
        </section>
    </main>
</body>